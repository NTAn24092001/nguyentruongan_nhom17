...
import 'package:nhom17/order_screen/components/order_place_detail.dart';
import 'package:nhom17/order_screen/components/order_status.dart';
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              const Divider(),
              10.heightBox,
              "Ordered Product".text.size(16).color(darkFontGrey).fontFamily(semibold).fontFamily(semibold).makeCentered(),
              10.heightBox,
              ListView(
